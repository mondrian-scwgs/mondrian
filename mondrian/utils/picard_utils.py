...
def merge_sam_files(
        inputs, output, mem="2G", docker_image=None
):
...
def sort_sam(
        bam_filename, sorted_bam_filename, tempdir, mem="2G", docker_image=None
):
    makedirs(tempdir)
...
def mark_duplicates(
        bam_filename, markduped_bam_filename, metrics_filename,
